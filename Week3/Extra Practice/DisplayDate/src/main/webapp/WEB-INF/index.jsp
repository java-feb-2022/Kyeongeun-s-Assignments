...
<body class="d-flex justify-content-center align-items-center fullwidth" style="height:500px;">
	<div class="d-flex justify-content-between width80">
		<div class="d-flex justify-content-center flex2"> <a href="/date">Date Template</a></div>
		<div class="d-flex justify-content-center flex2"> <a href="/time">Time Template</a></div>
